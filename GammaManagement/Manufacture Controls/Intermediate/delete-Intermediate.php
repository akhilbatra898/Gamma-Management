...
if ((isset($_GET['MediateSR'])) && ($_GET['MediateSR'] != "")) {
  $deleteSQL = sprintf("DELETE FROM intermediate WHERE MediateSR=%s",
                       GetSQLValueString($_GET['MediateSR'], "int"));

  mysql_select_db($database_localhost, $localhost);
  $Result1 = mysql_query($deleteSQL, $localhost) or die(mysql_error());

  $deleteGoTo = "Intermediate.php";
