...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO expenditure (purpose, amount, date_of_payment, signee) VALUES (%s, %s, %s, %s)",
...
mysql_select_db($database_localhost, $localhost);
$query_Expenditure = "SELECT * FROM expenditure";
   ...
   <body>
      ...
      <div class="container">
        <table class="table table-bordered">
          ...
          <?php do { ?>
            <tr>
              <td><?php echo $row_Expenditure['ExpSR']; ?></td>
              <td><?php echo $row_Expenditure['purpose']; ?></td>
              <td><?php echo $row_Expenditure['amount']; ?></td>
              <td><?php echo $row_Expenditure['date_of_payment']; ?></td>
              <td><?php echo $row_Expenditure['signee']; ?></td>
              <td><a href="update-expenditure.php?ExpSR=<?php echo $row_Expenditure['ExpSR']; ?>"> Update </a></td>
              <td><a href="delete-expenditure.php?ExpSR=<?php echo $row_Expenditure['ExpSR']; ?>">Delete</a></td>
            </tr>
            <?php } while ($row_Expenditure = mysql_fetch_assoc($Expenditure)); ?>
            </tbody>
        </table>
        <!--Insert Modal-->
                    ...
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                      <table align="center">
                        ...
                        <tr valign="baseline">
                          ...
                          <td><input type="text" name="amount" value="" size="32" min="0"></td>
                        </tr>
                        <tr valign="baseline">
                          <td nowrap align="right">Date_of_payment:</td>
                          <td><input type="text" name="date_of_payment" value="" size="32"></td>
                        </tr>
                        <tr valign="baseline">
