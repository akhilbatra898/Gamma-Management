...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO stock (product, market_rate, shelf_life) VALUES (%s, %s, %s)",
...
<html lang="en">
   ...
   <tbody>
          <?php do { ?>
            <tr>
              <td><?php echo $row_Stock['StockSR']; ?></td>
              <td><?php echo $row_Stock['product']; ?></td>
              <td><?php echo $row_Stock['market_rate']; ?></td>
              <td><?php echo $row_Stock['shelf_life']; ?></td>
              <td> <a href="update-stock.php?StockSR=<?php echo $row_Stock['StockSR']; ?>"> Update </a></td>
              <td><a href="delete-stock.php?StockSR=<?php echo $row_Stock['StockSR']; ?>"> Delete</a></td>
            </tr>
                  ...
                  <div class="modal-body">
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                      <table align="center">
                        ...
                        <tr valign="baseline">
                          <td nowrap align="right">Shelf_life:</td>
                          <td><input type="text" name="shelf_life" value="" size="32"></td>
                        </tr>
                        <tr valign="baseline">
